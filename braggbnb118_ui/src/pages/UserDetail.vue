						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="FirstName" type="text" placeholder="Enter FirstName" v-model="userToAdd.firstName"></base-input>
								  <base-input label="LastName" type="text" placeholder="Enter LastName" v-model="userToAdd.lastName"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">First Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FirstName" type="text" placeholder="Enter FirstName" v-model="userDetails.firstName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Last Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="LastName" type="text" placeholder="Enter LastName" v-model="userDetails.lastName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
